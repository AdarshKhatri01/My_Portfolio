...
const allSkills = [
  ...
  { name: "Python", logo: pythonLogo, proficiency: 90, category: "Programming Languages" },
  { name: "JavaScript", logo: javascriptLogo, proficiency: 85, category: "Programming Languages" },
  { name: "C", logo: cLogo, proficiency: 70, category: "Programming Languages" },
  { name: "C++", logo: cppLogo, proficiency: 75, category: "Programming Languages" },

  // Web Development
  { name: "HTML", logo: htmlLogo, proficiency: 95, category: "Web Development" },
  { name: "CSS", logo: cssLogo, proficiency: 90, category: "Web Development" },
  { name: "React", logo: reactLogo, proficiency: 90, category: "Web Development" },
  { name: "Next.js", logo: nextjsLogo, proficiency: 80, category: "Web Development" },
  { name: "Node.js", logo: nodeLogo, proficiency: 85, category: "Web Development" },
  { name: "Express.js", logo: expressLogo, proficiency: 85, category: "Web Development" },
  { name: "Tailwind CSS", logo: tailwindCSSLogo, proficiency: 95, category: "Web Development" },
  { name: "Material UI", logo: materialUILogo, proficiency: 80, category: "Web Development" },
  { name: "Bootstrap", logo: bootstrapLogo, proficiency: 75, category: "Web Development" },

  // Data Science & Analysis
  { name: "NumPy", logo: numpyLogo, proficiency: 80, category: "Data Science & Analysis" },
  { name: "Matlab", logo: matlabLogo, proficiency: 70, category: "Data Science & Analysis" },

  // CS Fundamentals
  { name: "Data Structures & Algorithms", logo: dsaLogo, proficiency: 85, category: "CS Fundamentals" },
  { name: "OOP", logo: oopLogo, proficiency: 85, category: "CS Fundamentals" },
  { name: "DBMS", logo: dbmsLogo, proficiency: 80, category: "CS Fundamentals" },

  // Developer Tools
  { name: "Git", logo: gitLogo, proficiency: 90, category: "Developer Tools" },
  { name: "GitHub", logo: githubLogo, proficiency: 95, category: "Developer Tools" },
  { name: "Linux", logo: linuxLogo, proficiency: 75, category: "Developer Tools" },
  { name: "MySQL", logo: mysqlLogo, proficiency: 80, category: "Developer Tools" },
];
  ...
  return (
    <section id="skills" className={styles.skills}>
      ...
      <div className={styles.skillCategories}>
        {Object.entries(groupedSkills).map(([categoryName, skillsArray]) => (
      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        <div className={styles.modalHeader}>
          <div className={styles.modalTitleContainer}>
            <img src={details.logo} alt={details.name} className={styles.modalLogo} />
            <h3 className={styles.modalTitle}>{details.name}</h3>
          </div>
          <button className={styles.closeButton} onClick={onClose}>×</button>
        </div>

        <div className={styles.modalDescription}>
          {details.description || `Details about ${details.name} will be added soon.`}
        </div>
              ...
              <div className={styles.strengthMeterContainer}>
                ...
                <div className={styles.strengthBar}>
                  <div
                    ...
                    style={{ width: `${details.proficiency || 50}%` }}
                  ></div>
